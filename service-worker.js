...
const CACHE_NAME_LITERAL = 'v179';
// Previous merged release marker retained for regression coverage: CACHE_NAME_LITERAL = 'v178'.
// Previous merged release marker retained for regression coverage: CACHE_NAME_LITERAL = 'v177'.
// Previous merged release marker retained for regression coverage: CACHE_NAME_LITERAL = 'v176'.
// Previous merged release marker retained for regression coverage: CACHE_NAME_LITERAL = 'v175'.
// Previous merged release marker retained for regression coverage: CACHE_NAME_LITERAL = 'v174'.
// Previous merged release marker retained for regression coverage: CACHE_NAME_LITERAL = 'v173'.
// Previous merged release marker retained for regression coverage: CACHE_NAME_LITERAL = 'v172'.
// Previous merged release marker retained for regression coverage: CACHE_NAME_LITERAL = 'v171'.
// Previous merged release marker retained for regression coverage: CACHE_NAME_LITERAL = 'v170'.
...
const SHELL_FILES = [
  ...
  './discoverV170.css',
  './discoverCorrectionsV171.css',
  './discoverFilterPillsV172.css',
  ...
  './mergedNextConcertV167.js',
  './nextConcertEventGroupV169.js',
  './lineupRoleV155.js',
  './eventModelV156.js',
  './dataLib.js',
  './europeScopeV160.js',
  ...
  './discoverV170.js',
  './discoverCorrectionsV171.js',
  './discoverFilterPillsV172.js',
