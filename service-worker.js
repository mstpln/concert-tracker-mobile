...
const CACHE_NAME_LITERAL = 'v163';
// Previous merged release marker retained for regression coverage: CACHE_NAME_LITERAL = 'v162'.
// Previous merged release marker retained for regression coverage: CACHE_NAME_LITERAL = 'v161'.
// Previous merged release marker retained for regression coverage: CACHE_NAME_LITERAL = 'v160'.
...
const SHELL_FILES = [
  './', './index.html', './app.css', './v72Corrections.css', './listeningV81.css', './concertCardsV86.css', './bandmarkrV87.css',
  './listeningReviewRollout.css', './toplistV96.css', './trustedListeningV99.css', './gau2SettingsV118.css', './settingsV123.css',
  './stateFeedbackV129.css', './nextConcertV138.css', './nextConcertV139.css', './nextConcertV140.css', './nextConcertV146.css',
  './startVisualV147.css', './nextConcertV148.css', './alignedUiV143.css', './alignedListeningBandsV144.css', './startStatsV149.css',
  './appUpdateAub1V153.css', './appUpdateAub2V155.css', './appUpdateAub3V156.css', './venueMetadataV158.css', './geoFilterPreloadV143.js',
  './app.js', './alignedUiV143.js', './nextConcertV138.js', './nextConcertV140.js', './nextConcertV146.js', './nextConcertV148.js',
  './interactionFeedbackV129.js', './stateFeedbackIntegrationV129.js', './providerReleaseCleanupV135.js', './gau2SettingsV118.js',
  './settingsV123.js', './settingsAutomationReportingV145.js', './listeningReviewRollout.js', './listeningReviewReconcile.js',
  './listeningCanonicalActivation.js', './listeningPreparationRecovery.js', './listeningPreparationV121.js', './gau5PreparationIntegrationV121.js',
  './listeningSpotifyIdentityReview.js', './listeningSpotifyIdentityReviewUi.js', './listeningIdentityPacingV105.js',
  './listeningIdentityCompletionV104.js', './listeningIdentityRecordingV106.js', './listeningIdentityGroupingV104.js', './devicePrivacy.js',
  './browserFetchPolicy.js', './v72Corrections.js', './v72FinalAdjustments.js', './securityHardening.js', './listeningInsightsV81.js',
  './listeningV81BootFix.js', './listeningV81ReviewFix.js', './listeningV82Corrections.js', './listeningV82GenreFix.js', './listeningV82FailSafe.js',
  './listeningV83ChartFix.js', './listeningV83WindowFix.js', './listeningV84ChartRenderFix.js', './listeningV85RankingAndStatsUnits.js',
  './toplistStatsV96.js', './toplistV96.js', './spotifyListeningMetadataV99.js', './spotifyListeningAlbumArtworkV113.js',
  './spotifyListeningMetadataV101.js', './trustedListeningV99.js', './uiPerformanceV126.js', './uiPerformanceV127.js', './alignedListeningBandsV144.js',
  './startStatsV149.js', './appUpdateAub1V153.js', './appUpdateAub1V153Corrections.js', './appUpdateAub3CorrectionV157.js',
  './venueMetadataModelV158.js', './venueMetadataV158.js', './lineupRoleV155.js', './eventModelV156.js', './dataLib.js', './europeScopeV160.js',
  './listeningStats.js', './listeningStatsV81.js', './listeningFixtures.js', './listeningFixturesV99.js', './listeningIdentityContracts.js',
  './listeningDerivedStorage.js', './listeningDerivedMigration.js', './spotifyHistoryImport.js', './listeningBandActivity.js', './listeningVaultBridge.js',
  './listeningVault.js', './listeningHistoryV2.js', './listeningIncrementalVault.js', './listenbrainzSync.js', './listenbrainzReportingV145.js',
  './spotifyHistoryBootstrap.js', './icons.js', './conflictMerge.js', './remoteStore.js', './ownedTickets.js', './musicbrainzState.js',
  './providerIdentityState.js', './weather.js', './spotifyUser.js', './spotifyUserV100.js', './version.js', './manifest.json',
  './icons/bandmarkr-wordmark.svg', './icons/icon-192.png', './icons/icon-512.png', './icons/icon-192-maskable.png', './icons/icon-512-maskable.png',
  './assets/listening/album-blue.svg', './assets/listening/album-purple.svg', './assets/listening/album-cyan.svg', './assets/listening/album-gold.svg',
];
...
self.addEventListener('activate', (event) => {
  event.waitUntil(caches.keys().then((keys) => Promise.all(keys.filter((k) => k.startsWith('concert-tracker-shell-') && k !== CACHE_NAME).map((k) => caches.delete(k)))));
  self.clients.claim();
});
