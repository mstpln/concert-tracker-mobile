...
test('release shell includes owned-ticket code and keeps the v60 cache pair synchronized', () => {
  ...
  assert.match(sw, /CACHE_NAME_LITERAL = 'v60'/);
  assert.match(version, /APP_VERSION = 'v60'/);
});
