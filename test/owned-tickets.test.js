...
test('release shell includes owned-ticket code and keeps the v70 cache pair synchronized', () => {
  ...
  assert.match(sw, /CACHE_NAME_LITERAL = 'v70'/);
  assert.match(version, /APP_VERSION = 'v70'/);
});
