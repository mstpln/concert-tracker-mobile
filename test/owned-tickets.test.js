...
test('release shell includes owned-ticket code and keeps the v65 cache pair synchronized', () => {
  ...
  assert.match(sw, /CACHE_NAME_LITERAL = 'v65'/);
  assert.match(version, /APP_VERSION = 'v65'/);
});
