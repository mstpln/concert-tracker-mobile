...
test('release shell includes owned-ticket code and keeps the v66 cache pair synchronized', () => {
  ...
  assert.match(sw, /CACHE_NAME_LITERAL = 'v66'/);
  assert.match(version, /APP_VERSION = 'v66'/);
});
