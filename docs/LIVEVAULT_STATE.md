...
A separate research decision registry can encode researched venue merge/separate decisions, field-level venue corrections, concert-to-canonical-venue assignments, explicit concert merge/separate decisions and evidence-backed festival editions. Venue corrections and reconciliation run before researched concert venue assignment, concert reconciliation and event/festival validation. Corrections retain before/after evidence in the manifest, while assignments preserve raw provider venue wording. Contradictory, incomplete or malformed decisions block rather than guessing. Merge/distinct contradictions are detected through current and legacy IDs, conflicting assignments and overlapping merge-survivor decisions block, and multi-member distinct resolution requires explicit all-pairs coverage.
