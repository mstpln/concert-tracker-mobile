...
Build 3.3B — Toplist is the next focused user-visible slice of issue #71. It renames the Top bands destination to Toplist, adds Top Bands and Top Tracks segmented tabs, retains 2 weeks, 3 months, 1 year and All time, defaults a fresh visit to Top Bands and 3 months, preserves in-page selection, and adds conservative global Top Tracks ranking with synthetic desktop and mobile QA. The Listening Stats overview card, trusted Spotify track and album links, identity-backed artwork and selected-year genre-detail reconciliation remain deferred to later focused Build 3.3 slices. General App Updates remain deferred to issue #72. Offline Concert Access has been permanently removed and is not part of the plan.
