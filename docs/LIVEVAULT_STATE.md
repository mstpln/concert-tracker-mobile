...
- Trusted release evidence is probable only when both durations are known, positive and within 2,000 ms; artist/title, live, remix, cover, tribute and same-name text evidence never auto-merges.
